#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# (c) Shadow King U K & @ShadowKing9o
    ...
    if update_channel:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Support Channel', url='https://t.me/ShadowsArena'),
                    InlineKeyboardButton('Feedback', url='https://t.me/ShadowKing9o')
                ],
                [
                    InlineKeyboardButton('Other Bots', url='https://t.me/ShadowsArena'),
                    InlineKeyboardButton('Source', url='https://github.com/MasterShad0w/restartrenamer')
                ]
            ]
        ),
